...
- Good experience working with ASP.NET MVC, C#, Web API, HTML5, CSS, JavaScript, XML, JSON, NodeJS, ReactJS, MongoDB, SQL Server and Oracle.
...
#### **TOOLS**
##### `Visual Studio` `GitHub` `Jenkins` `Octopus` `Postman` `Dynatrace` `Jira` `VersionOne` `ServiceNow` `Splunk` `Visio` `Slack` `MS Teams` `MS Office`
